...
# Input MFs
def mu_usia_muda(x):   return trapmf(x, 0, 0, 40, 50)
def mu_usia_sedang(x): return trapmf(x, 40, 50, 55, 62)
def mu_usia_tua(x):    return trapmf(x, 55, 62, 120, 120)
def mu_bp_normal(x):   return trapmf(x, 0, 0, 110, 125)
def mu_bp_pre(x):      return trapmf(x, 110, 125, 135, 145)
def mu_bp_hiper(x):    return trapmf(x, 135, 145, 300, 300)
def mu_bplo_normal(x): return trapmf(x, 0, 0, 80, 85)
def mu_bplo_pre(x):    return trapmf(x, 80, 85, 90, 100)
def mu_bplo_hiper(x):  return trapmf(x, 90, 100, 200, 200)
def mu_bmi_normal(x):  return trapmf(x, 0, 0, 22, 26)
def mu_bmi_over(x):    return trapmf(x, 22, 26, 28, 32)
def mu_bmi_obese(x):   return trapmf(x, 28, 32, 100, 100)
